...
If you have any comment about contents in this website, feel free to send an
email to [public-inbox](mailto:public-inbox@revi.email). (Archives of the email
is available at [revi.topicbox.com](https://revi.topicbox.com/groups/public-inbox).)

## Credit {#credit}

I'd like to thank these people for inspiration:

- [Aaron Parecki](https://aaronparecki.com/now/) for [/time/](../time/).
