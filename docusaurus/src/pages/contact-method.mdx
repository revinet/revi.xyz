...
- I do not use [Telegram](https://telegram.org) as a regular messenger, most of the time.
...
- I use telegram only for home automation notifications as it is the one of the only messenger that has proper multi-device support with push notifications.
